...
export const pointFromBytes = (value: Uint8Array): Point => p384.Point.fromBytes(value)
export const scalarFromBytes = (value: Uint8Array): bigint => p384.Point.Fn.fromBytes(value)
